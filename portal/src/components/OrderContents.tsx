...
function DrawerRow({
  ...
  return (
    <div
      ...
      // A click anywhere non-interactive opens the drawer quick view — large
      // photo, links, 3D scan. Clicks on links/buttons/inputs (Organize forms
      // live inside the row) keep their normal behavior.
      onClick={(e) => {
